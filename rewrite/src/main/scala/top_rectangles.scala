...
//   hsync_p1 := hsync.prev(1)
//   vsync_p1 := vsync.prev(1)
//   vga_hsync := hsync_p1.prev(1)
//   vga_vsync := vsync_p1.prev(1)
//   vga_r := fb_red.prev(1)
//   vga_g := fb_green.prev(1)
//   vga_b := fb_blue.prev(1)
